...
public class Workout {
    ...
    public Workout(Activity pAct, JSONArray pDesc) throws JSONException {
        ...
        countdownManager = new CountdownManager(this,
                new ActionCountdown(this, myExercise),
                new RestCountdown(this, myExercise.getRestTime() * 1000),
                new AfterCountdown(this, myExercise.getAfterTime() * 1000),
                myExercise);
    ...
    public void playPause() throws JSONException {
